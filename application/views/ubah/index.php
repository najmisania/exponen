...
<?php $this->load->view('template/sidebar') ?>
    ...
    <?php $this->load->view('template/endnavbar') ?>
		...
		<div class="card card-tasks" style="height: 500px;">	
		  ...
		  <div class="card-body ">
		  <?php echo form_open('ubah/update_mhs'); ?>
			<div class="input-group mb-3">
				<input type="hidden" name="npm_asli" value="<?php echo $biodata_mhs->npm ?>">
			  <div class="input-group-prepend">
				<span class="input-group-text" id="inputGroup-sizing-default" style="font-size:0.7rem;" >Nama</span>
			  </div>
			  <input type="text" class="form-control" aria-label="Default" placeholder="*Nama Mahasiswa*" aria-describedby="inputGroup-sizing-default" name="nama" value="<?php echo $biodata_mhs->nama ?>"  required>
			</div>
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
				<span class="input-group-text" id="inputGroup-sizing-default" style="font-size:0.7rem;">NPM</span>
			  </div>
			  <input type="text" class="form-control" aria-label="Default" placeholder="*NPM Mahasiswa*" aria-describedby="inputGroup-sizing-default" name="npm" value="<?php echo $biodata_mhs->npm ?>" readonly required>
			</div>
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
				<span class="input-group-text" id="inputGroup-sizing-default" style="font-size:0.7rem;">Nomor Telepon</span>
			  </div>
			  <input type="text" class="form-control" name="no_tlp" value="<?php echo $biodata_mhs->no_tlp ?>" aria-label="Default" aria-describedby="inputGroup-sizing-default">
			</div>
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
				<span class="input-group-text" id="basic-addon1" style="font-size:0.7rem;">Alamat</span>
			  </div>
			  <input type="text" class="form-control" name="alamat" value="<?php echo $biodata_mhs->alamat ?>"placeholder="" aria-label="Email" aria-describedby="basic-addon1">
			</div>
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
